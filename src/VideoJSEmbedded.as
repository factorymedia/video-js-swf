package{
    ...
    import com.videojs.VideoJSUIControls;
    ...
    public class VideoJSEmbedded extends Sprite{
        
        private var _app:VideoJSApp;
        private var _stageSizeTimer:Timer;
        private var _controls:VideoJSUIControls;
        
        public function VideoJSEmbedded(){
        ...
        private function init():void{
            ...
            log("EXPERIMENTAL FACTORY MEDIA EMBEDDED PLAYER");
            
            // add content-menu version info
            var _ctxVersion:ContextMenuItem = new ContextMenuItem("VideoJS Flash Component v4.0.11", false, false);
            var _ctxAbout:ContextMenuItem = new ContextMenuItem("Copyright © 2014 Factory Media Ltd.", false, false);
            var _ctxMenu:ContextMenu = new ContextMenu();
            _ctxMenu.hideBuiltInItems();
            _ctxMenu.customItems.push(_ctxVersion, _ctxAbout);
            this.contextMenu = _ctxMenu;
            
            _controls = new VideoJSUIControls(this);
            addChild(_controls);
        ...
        private function registerInternalEvents():void{
          addEventListener("vjs_appendBuffer", onAppendBufferCalled);
          addEventListener("vjs_echo", onEchoCalled);
          addEventListener("vjs_autoplay", onAutoplayCalled);
          addEventListener("vjs_src", onSrcCalled);
          addEventListener("vjs_load", onLoadCalled);
          addEventListener("vjs_play", onPlayCalled);
          addEventListener("vjs_pause", onPauseCalled);
          addEventListener("vjs_resume", onResumeCalled);
          addEventListener("vjs_stop", onStopCalled);
        }
        ...
        public function getProperty(pPropertyName:String = ""):* {
        ...
        private function onPlayCalled(e:Event = null):void{
            _app.model.play();
        }
        
        private function onPauseCalled(e:Event = null):void{
            log("PAUSE CALLED!");
            _app.model.pause();
        }
